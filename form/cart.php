...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="../index.php"><span style="color:black;font-family: 'Permanent Marker', cursive;">DESI STOP</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="cart.php"><span style="color:black; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:black;" id="cart"  class="badge badge-light"><?php if(isset($re)) echo $re; ?></span></i></span></a>
...
<div class="middle" style="  padding:60px; border:1px solid #ED2553;  width:100%;">
       <!--tab heading-->
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#106059;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
	...
	<!--tab 1 starts-->   
	   <div class="tab-content" id="myTabContent">
                 ...
                 <table class="table">
                  <tbody>
	               <?php
	                ...
	                ?>
                      <tr>
                         <td><image src="images<?php echo $em."/foodimages/".$res['fldimage'];?>" height="80px" width="100px"></td>
                   ...
                   <?php
	                 ...
	                 ?>
					 <tr><button type="button" class="btn btn-outline-success"><a href="../index.php" style="color:black; text-decoration:none;">No Items In cart Let's Shop Now</a></button></tr>
		  ...
		  <span style="color:black; text-align:centre;"><?php if(isset($success)) { echo $success; }?></span>

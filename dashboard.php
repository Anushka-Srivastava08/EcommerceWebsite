...
<div class="container">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#106059;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#BDDEFD;" id="viewitem-tab" data-toggle="tab" href="#viewitem" role="tab" aria-controls="viewitem" aria-selected="true">View Items</a>
          </li>
          <li class="nav-item">
                 ...
                 <thead>
                    <tr>
                        <th scope="col">Vendor_Id</th>
							...
							<th scope="col">Quamb_encode_numericentity</th>                
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="images/<?php echo $row['fld_email']."/foodimages/" .$row['fldimage'];?>" height="50px" width="100px">
...
<!--tab 1 ends-->	   
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="images/<?php echo $row['fld_email']."/" .$row['fld_logo'];?>" height="50px" width="100px"></td>
                        <th scope="row"><?php echo $row['fldvendor_id'];?></th>
						<td><?php echo $row['fld_name'];?></td>

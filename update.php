                  ...
                  <!--add Product-->
                        <form action="" method="post" enctype="multipart/form-data">
                                     ...
                                     <label for="food_name">Product Name:</label>
                                            <input type="text" class="form-control" id="food_name" value="<?php if(isset($rfuelname)) { echo $rfuelname;}?>" placeholder="Enter Item Name" name="food_name" required>
                                     </div>
	                                ...
	                                <div class="form-group">
                                         ...
                                         <input type="file" accept="image/*" name="food_pic"/>Product Snaps 
                                    </div>
